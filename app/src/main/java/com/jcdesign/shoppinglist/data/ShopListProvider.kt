...
import com.jcdesign.shoppinglist.presentation.ShopListApp
...
class ShopListProvider : ContentProvider() {
    ...
    private val uriMatcher = UriMatcher(UriMatcher.NO_MATCH).apply {
        addURI("com.jcdesign.shoppinglist", "shop_item/", GET_SHOP_ITEMS_QUERY)
        addURI("com.jcdesign.shoppinglist", "shop_item/#", GET_SHOP_ITEM_ID_QUERY)
    }
